...
<section class="handbook-hero">
    <div>
        <span class="eyebrow">دليل المصممة</span>
        <h1>دليل العمل والتقييم داخل iConz</h1>
        <p class="muted">
...
<section class="grid two handbook-section">
    ...
    <div class="handbook-card">
        ...
        <p class="muted">
            عند إنشاء مصممة جديدة يتم فتح ملف متابعة لها. بعد ذلك تسجل المتابعة الأسبوعية وملاحظات الأداء بشكل منفصل، وكلها ترتبط بنفس المصممة لتظهر للإدارة في لوحة واضحة.
        </p>
    </div>
</section>
