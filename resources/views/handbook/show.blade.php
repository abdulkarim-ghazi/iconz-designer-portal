...
<section class="grid two handbook-section">
    ...
    <div class="handbook-card">
        ...
        <p class="muted">
            عند إنشاء مصممة جديدة يتم فتح سجل تقييم لها. بعد ذلك تسجل المتابعة الأسبوعية وملاحظات الأداء بشكل منفصل، وكلها ترتبط بنفس المصممة لتظهر للإدارة في لوحة واضحة.
        </p>
    </div>
</section>
